 ...
 *
 */
public class AbstractEntityRenderer {
	...
	public void render (AbstractEntity entity, BasicEntityShader shader, AbstractCamera camera) {
		...
		} else if(entity.getModel() instanceof TexturedModel) {
	 ...
	 */
	public void setup(BasicEntityShader shader, int type) {
	 ...
	 */
	public void loadCamera(BasicEntityShader shader, AbstractCamera camera, int type) {
		shader.setType(type);
